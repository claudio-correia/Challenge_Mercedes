...
public class FindTheClosestDealerTests {
    ...
    public void TestBadInput() throws Exception {
        ...
        MvcResult result =this.mockMvc.perform(get("/getclosestvehicle")
                .param("model", "adas")
                .param("fuel", "ELECTRIC")
        ...
        result =this.mockMvc.perform(get("/getclosestvehicle")
                .param("model", "AMG")
                .param("fuel", "ELECTRIC")
    ...
    public void FindClosestDealer () throws Exception {
        ...
        MvcResult result =this.mockMvc.perform(get("/getclosestvehicle")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value("846679bd-5831-4286-969b-056e9c89d74c"))
    ...
    public void FindClosestDealer2 () throws Exception {
        ...
        MvcResult result =this.mockMvc.perform(get("/getclosestvehicle")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value("d4f4d287-1ad6-4968-a8ff-e9e0009ad5d1"))
    ...
    public void FindClosestDealer3 () throws Exception {
        ...
        MvcResult result =this.mockMvc.perform(get("/getclosestvehicle")
                ...
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value("bbcdbbad-5d0b-45ef-90ac-3581b997e063"))
